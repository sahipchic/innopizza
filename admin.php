...
<head>
 ...
 <script>
     function sendReviewAction(id, action) {
            jQuery.ajax({
                url: 'getReviewAction.php',
                dataType: 'json',
                type: 'post',
                contentType: 'application/json',
                data: JSON.stringify({"review_id": id, "action": action}),
        ...
        function sendRequestAction(id, action) {
            jQuery.ajax({
                url: 'getRequestAction.php',
                dataType: 'json',
                type: 'post',
                contentType: 'application/json',
      ...
      <?php
        ...
        while($row = $result_set->fetch_assoc()){
            ...
            $out .= "<tr>
                        ...
                        <div><button class=\"btn btn-success\" onclick=\"sendReviewAction('$id', 'accept');\">Accept</button></div>
                        <div style='padding-left: 10px;'><button class=\"btn btn-danger\" onclick=\"sendReviewAction('$id', 'reject');\">Reject</button></div>
                        </div>
                        </td>
                    </tr>";
        }
      ...
      <?php
        ...
        while($row = $result_set->fetch_assoc()){
            ...
            $out .= "<tr>
                        ...
                        <td>$time</td>
                        <td>
                        <button class=\"btn btn-danger\" onclick=\"sendReviewAction('$id', 'delete');\">Delete</button>
                        </td>
                    </tr>";
        }
        echo $out;
      ...
      <?php
        ...
        while($row = $result_set->fetch_assoc()){
            ...
            $out .= "<tr>
                        ...
                        <td>$time</td>
                        <td>
                        <button class=\"btn btn-danger\" onclick=\"sendRequestAction('$id', 'delete');\">Delete</button>
                        </td>
                    </tr>";
        }
        echo $out;
