...
<div class="row">
    <div class="col-75">
        <div class="container">
            <form action="../backend/getCustomerInfo.php" method="post">
                <div class="row">
                    <div class="col-50">
                ...
                if (isset($_SESSION['pizzas'])) {
                    if(count($_SESSION['pizzas']) == 0) echo 'disabled style="background-color: grey;"';
                } else echo 'disabled style="background-color: grey;"';
